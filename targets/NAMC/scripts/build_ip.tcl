...
#
# Create FMC 10G GTX Aurora IP
#
create_ip -vlnv [get_ipdefs -filter {NAME == gtwizard}] \
-module_name fmcgtx_10G -dir $BUILD_DIR
 


set_property -dict [list CONFIG.identical_protocol_file {aurora_8b10b_single_lane_2byte} \
 ...
 CONFIG.identical_val_tx_reference_clock {125.000} \
 CONFIG.identical_val_rx_reference_clock {125.000} \
 CONFIG.gt0_val_protocol_file {aurora_8b10b_single_lane_2byte} \
 ...
 CONFIG.gt0_val_clk_cor_seq_len {2} \
...
generate_target all [get_files $BUILD_DIR/fmcgtx_10G/fmcgtx_10G.xci]
synth_ip [get_ips fmcgtx_10G]
